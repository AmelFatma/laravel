    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="/shop-single"> <img src="images/product_05.png" alt="Image"></a>
            <h3 class="text-dark"><a href="/shop-single">CLA Core</a></h3>
            <p class="price">$38.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <span class="tag">Sale</span>
            <a href="/shop-single"> <img src="images/product_06.png" alt="Image"></a>
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="/shop-single"> <img ˀsrc="images/product_03.png" alt="Image"></a>
            <h3 class="text-dark"><a href="/shop-single">Umcka Cold Care</a></h3>
            <p class="price">$120.00</p>
          </div>
